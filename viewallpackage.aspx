<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="viewallpackage.aspx.cs" Inherits="tour.viewallpackage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
    <h2 style="text-align:center; "  class="auto-style7">Search Package</h2>
        <br/><br/><br/>
        ...
        <div class="form-group">
            <div class="col-md-2"></div>
                        ...
                        <%--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnupdate" cssClass="btn btn-success" runat="server" Text="Update" OnClick="btnupdate_Click" />--%>
                            ...
                            <asp:Button ID="btnsearch" cssClass="btn btn-success" runat="server" Text="Search Package" OnClick="btnsearch_Click"   />&nbsp;&nbsp;<table class="nav-justified">
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:GridView ID="gvReport" CssClass="auto-style8" runat="server" AutoGenerateColumns="False" CellPadding="3" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellSpacing="2" >
                                            <Columns>
...
<ItemStyle HorizontalAlign="Justify"></ItemStyle>
                                                ...
                                                <asp:TemplateField HeaderText="Delete">
                                                    <ItemTemplate>
                                                        <asp:Button ItemStyle-HorizontalAlign="Justify" ID="btndelete" runat="server"  Text="Delete" OnClick="btndelete_Click" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
