...
namespace tour
{
    public partial class addpackage : System.Web.UI.Page
    {
        ...
        public void BindData()
        {
            SqlConnection con = new SqlConnection(Connection);
            con.Open();
            string query = "Select *from package where agency='"+txtaname.Text+ "' OR pname='" + txtpackagename.Text + "' ";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.CommandType = CommandType.Text;
            cmd.ExecuteNonQuery();
        ...
        {
            {
                ...
                SqlConnection con = new SqlConnection(Connection);
                con.Open();
                string query = "select * from Package where pname='" + txtpackagename.Text + "'   Or agency='"+txtaname.Text+"'";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.CommandType = CommandType.Text;
                cmd.ExecuteNonQuery();
        ...
        //    Timer1.Now = DateTime.Now.ToLongDateString();
        //    Timer1.Now = DateTime.Now.ToLongTimeString();
        //}

        //protected void ddlaname_SelectedIndexChanged(object sender, EventArgs e)
        //{

        //    //SqlConnection con = new SqlConnection(Connection);
        //    //con.Open();
        //    //string query = "select *from users where uid='" + ddlaname.SelectedItem.Value + "'";
        //    //SqlCommand cmd = new SqlCommand(query, con);
        //    //cmd.CommandType = CommandType.Text;
        //    //cmd.ExecuteNonQuery();
