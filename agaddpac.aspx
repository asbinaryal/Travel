<%@ Page Title="" Language="C#" MasterPageFile="~/agency.Master" AutoEventWireup="true" CodeBehind="agaddpac.aspx.cs" Inherits="tour.agaddpac" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

 <h2 style="text-align:center; position:absolute; top:50px;"  class="auto-style7">Add Package</h2>
        <br/><br/><br/>
    ...
    <div class="form-horizontal" >
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                ...
                <asp:TextBox ID="txtaname" CssClass="form-control" runat="server" OnTextChanged="txtaname_TextChanged" Enabled="False"></asp:TextBox>
            </div>
            </div>
